...
`breaking_events.yml` 每小时运行一次,监控突发的历史性重大国际事件,例如:

- 某大国突然开战或发动大规模军事打击
- 具有全球影响的核/战略导弹事件
- 对某大国国家元首或最高政治领导人的刺杀或刺杀未遂(例如刺杀美国总统)
- 某主要国家突然爆发政治宪政危机,如戒严、军事接管、政府首脑被弹劾或下台、议会/国会遭占领或冲击、政府突然垮台
- 政变、灾难级全球性袭击或灾难、和平谈判突然破裂并立即引发新的战争

检测到后立即通过微信推送。阈值依然较高:常规外交、普通选举、政治丑闻、孤立事件、已可预期的事件一律忽略,同一事件只提醒一次。
